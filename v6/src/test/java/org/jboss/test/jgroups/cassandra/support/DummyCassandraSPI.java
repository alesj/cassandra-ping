 ...
 */
public class DummyCassandraSPI implements CassandraSPI
{
   public boolean createKeyspace(String keyspaceName)
   {
      return false;
   }
   ...
   public boolean createColumnFamily(String keyspaceName, String columnFamily)
   {
      return false;
   }
